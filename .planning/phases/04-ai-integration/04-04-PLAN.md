...
<task type="auto">
  <name>Task 1: Create type compatibility validator</name>
  <files>src/validator/types.ts</files>
  <action>
...
```
  ...
  <done>validateTypeCompatibility function exported from types.ts</done>
</task>
