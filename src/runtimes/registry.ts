/**
 * Runtime Registry for FlowScript
 *
 * Provides the registry singleton for managing runtime implementations.
 * Separated from index.ts to avoid circular dependencies with runtime implementations.
 */
